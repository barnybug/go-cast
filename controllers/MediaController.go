...
var getMediaStatus = cast.PayloadHeaders{Type: "GET_STATUS"}

var commandMediaPlay = cast.PayloadHeaders{Type: "PLAY"}
var commandMediaPause = cast.PayloadHeaders{Type: "PAUSE"}
var commandMediaStop = cast.PayloadHeaders{Type: "STOP"}
...
func NewMediaController(client *cast.Client, sourceId, destinationID string) *MediaController {
